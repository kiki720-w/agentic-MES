...
本版发布验证结果：Ruff、Mypy 和 Vite 构建通过；Core 测试为 145 项通过、5 项因未配置隔离 PostgreSQL 测试库而跳过；打包后的七个桌面页面全部完成加载和滚动检查，没有前端运行时异常。便携安装包为 `desktop/release/CAPAXION-0.3.0-x64.exe`，SHA256 为 `C8F5C406CE3223B74020845117D14D3263449C54D440E4FE04E81FA7A3ADAACB`。
